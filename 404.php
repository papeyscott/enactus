...
<!-- Mirrored from thememascot.net/demo/personal/s/fundpro/v2.0/demo/page-404-style2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 18 Mar 2018 01:03:34 GMT -->
<head>
          ...
          <div class="container pt-0 pb-0">
            <div class="row">
              <div class="col-md-7">
                ...
                <h2 class="mt-0">Oops! Page Under Construction</h2>
                <p>Kindly check back Later or contact us.</p>
                <!--<a class="btn btn-border btn-gray btn-transparent btn-circled smooth-scroll-to-target" href="index.php">Return Home
                </a>-->
              </div>
              <div class="col-md-4">
                <h3></h3>
