...
$item = Utils::getVolunteerByID($pdo, $sfid);
...
if (array_key_exists('submit', $_POST)) {
  ...
  if (empty($errors)) {
    ...
    $clean['id'] = $sfid;
    Utils::updateVolunteer($pdo, $clean);
    Utils::redirect('viewvolunteer.php', "Successfully Added");
  }
}
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <a href="addvolunteer.php" class="small-box-footer">Add People Content <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            ...
            <a href="viewvolunteer.php" class="small-box-footer">View People Content <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
