...
$item = Utils::getNationalsByID($pdo, $sfid);
 ...
 if (empty($_POST['story'])) {
  ...
  if (empty($errors)) {
    ...
    $clean['id'] = $sfid;
     ...
     Utils::updateNationals($pdo, $clean);
    Utils::redirect('viewnationals.php', "Successfully Added");
  }
}
          ...
          <div class="small-box bg-green">
            <div class="inner">
                <?php
                      ...
                      $result = mysqli_query($con, "select count(1) FROM nationals");
            ...
            <a href="addnationals.php" class="small-box-footer">Add Content <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            ...
            <a href="viewnationals.php" class="small-box-footer">View Content <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
                    ...
                    <form class="form-horizontal" action="" method="post">
                      ...
                      <div class="box-body">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <textarea class="form-control" id="editor1" name="story" rows="5" cols="10"><?php echo $item['story']; ?></textarea>
                              </div>
                            </div>
