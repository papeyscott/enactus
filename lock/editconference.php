...
$item = Utils::getConferenceByID($pdo, $sfid);
 ...
 if (empty($_POST['story'])) {
  ...
  if (empty($errors)) {
    ...
    $clean['id'] = $sfid;
     ...
     Utils::updateConference($pdo, $clean);
    Utils::redirect('viewconference.php', "Successfully Added");
  }
}
          ...
          <div class="small-box bg-green">
            <div class="inner">
                <?php
                      ...
                      $result = mysqli_query($con, "select count(1) FROM conference");
            ...
            <a href="addconference.php" class="small-box-footer">Add People Content <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            ...
            <a href="viewconference.php" class="small-box-footer">View People Content <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
